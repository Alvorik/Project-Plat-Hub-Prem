...
CreditSection:NewLabel("Made By Alvorik/エド2kk#0001")

CreditSection:NewButton("Copy Discord Link", "Copy Alvorik's World's Discord Server", function()
...
-- Clicker, Ninja Legends, MM2, Blox Fruits
...
elseif game.PlaceId == 142823291 then
	...
	local MM2Section = MM2:NewSection("Murder Mystery 2 | Premium")
